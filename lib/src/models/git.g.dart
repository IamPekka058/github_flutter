...
CreateGitBlob _$CreateGitBlobFromJson(Map<String, dynamic> json) =>
    CreateGitBlob(json['content'] as String?, json['encoding'] as String?);
...
CreateGitCommit _$CreateGitCommitFromJson(
...
Map<String, dynamic> _$CreateGitTreeToJson(CreateGitTree instance) =>
    <String, dynamic>{'base_tree': instance.baseTree, 'tree': instance.entries};
