...
Ref _$RefFromJson(Map<String, dynamic> json) => Ref(json['from'] as String?);

Map<String, dynamic> _$RefToJson(Ref instance) => <String, dynamic>{
  'from': instance.from,
};

Sha _$ShaFromJson(Map<String, dynamic> json) => Sha(json['from'] as String?);
...
Body _$BodyFromJson(Map<String, dynamic> json) => Body(json['from'] as String?);
...
Title _$TitleFromJson(Map<String, dynamic> json) =>
    Title(from: json['from'] as String?);
