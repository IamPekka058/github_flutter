...
Map<String, dynamic> _$CommitInfoToJson(CommitInfo instance) =>
    <String, dynamic>{'sha': instance.sha, 'tree': instance.tree};
...
RepositorySlug _$RepositorySlugFromJson(Map<String, dynamic> json) =>
    RepositorySlug(json['owner'] as String, json['name'] as String);

Map<String, dynamic> _$RepositorySlugToJson(RepositorySlug instance) =>
    <String, dynamic>{'owner': instance.owner, 'name': instance.name};
...
LicenseDetails _$LicenseDetailsFromJson(
  Map<String, dynamic> json,
) => LicenseDetails(
  name: json['name'] as String?,
  ...
  gitUrl: json['git_url'] == null ? null : Uri.parse(json['git_url'] as String),
  downloadUrl:
