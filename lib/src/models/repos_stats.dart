...
class ContributorParticipation {
  ContributorParticipation({this.all, this.owner});
...
class WeeklyChangesCount {
  WeeklyChangesCount({this.timestamp, this.additions, this.deletions});
...
class PunchcardEntry {
  PunchcardEntry({this.weekday, this.hour, this.commits});
