...
Rename _$RenameFromJson(Map<String, dynamic> json) =>
    Rename(from: json['from'] as String?, to: json['to'] as String?);
...
TemplateRepository _$TemplateRepositoryFromJson(
...
HtmlLink _$HtmlLinkFromJson(Map<String, dynamic> json) =>
    HtmlLink(href: json['href'] as String?);
...
PullRequestLink _$PullRequestLinkFromJson(Map<String, dynamic> json) =>
    PullRequestLink(href: json['href'] as String?);
